                ...
                <div class="permissions-list-rows-container">
                  ...
                  <div class="permissions-list-row">
                    ...
                    <div class="permissions-list-row-actions">
                      ...
                      <a href="{{route('permission.edit',$permission->id)}}"><iconify-icon icon="akar-icons:edit" class="permissions-list-row-icon"></iconify-icon></a>
                      <a href="{{route('permission.destroy',$permission->id)}}"><iconify-icon icon="fluent:delete-16-regular" class="permissions-list-row-icon"></iconify-icon></a>
                    </div>
