              ...
              <div class="create-referee-inputs-parent-container">
                ...
                <div class="create-referee-inputs-row">
                  <div class="create-referee-name-container">
                    ...
                    <input type="text" placeholder="Enter Your Name" name="name" id="name" value="{{ old('name', $operation_staff->name) }}" autofocus>
                    @error('name')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                  </div>
                  <div class="create-referee-phno-container">
                    ...
                    <input type="number" placeholder="Enter Your Phone Number" name="phone" id="phone" value="{{ old('phone', $operation_staff->phone) }}">
                    @error('phone')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                  </div>
                ...
                <div class="create-referee-inputs-row">
                  <div class="create-referee-pw-container">
                    ...
                    <input type="password" placeholder="Enter Password" name="password" id="password"  value="{{ old('password', $operation_staff->password) }}">
