...
// dd($refereesaleamounts->maincash);
        $refereesaleamount=Referee::join('agents','referees.id','=','agents.referee_id')
        ...
        ->sum('twodsalelists.sale_amount' ,'threedsalelists.sale_amount','lonepyinesalelists.sale_amount');
